...
from processors.fns import source_file_checker, depo_cost_parser
...
def prepared_maker():
    ...
    while os.path.exists(os.path.join('files', '~$сводка подготовки к передаче на актирование.xlsx')):
        ...
        print(Fore.RED, 'Закройте файл "сводка подготовки к передаче на актирование.xlsx" и нажмите ввод', Fore.RESET, end = '')        
        input()
    ...
    print(Fore.GREEN, 'Подготовлен файл для отправки на актирование и сводка по строкам, которые не попали в этот файл')
